package mad.otter.game.map;

import javafx.animation.AnimationTimer;
import javafx.scene.image.ImageView;
import javafx.scene.shape.Rectangle;
import mad.otter.game.model.*;
import mad.otter.game.model.block.*;
import mad.otter.game.model.enemy.Boomer;
import mad.otter.game.model.enemy.Enemy;
import mad.otter.game.model.enemy.Slime;
import mad.otter.game.model.enemy.Turret;
import mad.otter.game.model.hero.Hero;
import mad.otter.game.model.item.Item;
import mad.otter.game.model.item.Sign;
import mad.otter.game.model.item.guns.PoisonDagger;
